...
temp_2 <- mk_annotated_delta_df(
  ...
  threshold_change = 100.07,     # 
  threshold_change_res = 1.63, # <- max groupwise collapsed iqr
  ith_condition = c("PS.22.High.Amp", "PS.90.HA")
)

...
annotated_delta_df_diagnostic(df = temp_2)
...
anova(fm, fm_reduced) # note that the "1st" model is not the first one input but the simpler one.
# ED(fm, c(10, 50, 90))
compParm(fm, "d")
...
#TODO fcn that takes fm, time and returns predictions



#TODO fcn that takes predictions, data and plots a second diagnostic
